...
def data_processing_ex(method, type, model, amounttraining, amounttest,amountinducing):
    ...
    if type == 'own_data':
          trainingValues = pd.read_csv('C:/Users/lenne/Desktop/bestanden/ku leuven/thesis/python/trainingValues_am_10000_exact')
          trainingParameters = pd.read_csv('C:/Users/lenne/Desktop/bestanden/ku leuven/thesis/python/trainingParameters_am_10000_exact')
